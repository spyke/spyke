#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Thu May 01 06:10:24 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.events_sizer_staticbox = wx.StaticBox(self.events_pane, -1, "stuf")
        ...
        wxglade_tmp_menu.Append(wx.ID_NEW, "&New", "Create new collection", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_OPEN, "&Open", "Open .srf or .sort file", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_SAVE, "&Save", "Save collection", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_SAVEAS, "Save As", "Save collection as", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.ID_CLOSE, "&Close", "Close .srf file", wx.ITEM_NORMAL)
        ...
        # Tool Bar end
        self.slider = wx.Slider(self.file_control_panel, -1, 0, 0, 1000000, style=wx.SL_HORIZONTAL|wx.SL_LABELS|wx.SL_SELRANGE)
        ...
        self.Bind(wx.EVT_COMMAND_SCROLL, self.OnSliderScroll, self.slider)
        # end wxGlade
    ...
    def OnSliderScroll(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnSliderScroll' not implemented!"
        event.Skip()
...
class SpikeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wx.CAPTION|wx.CLOSE_BOX|wx.MINIMIZE_BOX|wx.MAXIMIZE_BOX|wx.SYSTEM_MENU|wx.RESIZE_BORDER|wx.FRAME_TOOL_WINDOW|wx.FRAME_NO_TASKBAR|wx.CLIP_CHILDREN
        wx.Frame.__init__(self, *args, **kwds)
