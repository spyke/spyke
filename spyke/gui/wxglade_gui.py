#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Sun Jun 08 03:44:56 2008
...
class SortFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        # Tool Bar end
        self.sort_tree_ctrl = wx.TreeCtrl(self.sort_pane, -1, style=wx.TR_HAS_BUTTONS|wx.TR_LINES_AT_ROOT|wx.TR_DEFAULT_STYLE|wx.NO_BORDER)
        self.sort_list_ctrl = wx.ListCtrl(self.sort_pane, -1, style=wx.LC_REPORT|wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        sort_sizer = wx.BoxSizer(wx.HORIZONTAL)
        sort_sizer.Add(self.sort_tree_ctrl, 1, wx.EXPAND, 0)
        sort_sizer.Add(self.sort_list_ctrl, 1, wx.EXPAND, 0)
        self.sort_pane.SetSizer(sort_sizer)
