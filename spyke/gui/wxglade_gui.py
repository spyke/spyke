#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Mon Jun 30 13:35:27 2008
...
from spyke.core import SpykeListCtrl
...
class SortFrame(wx.MiniFrame):
    def __init__(self, *args, **kwds):
        ...
        self.list_pane = wx.Panel(self.sort_splitter, -1)
        self.tree_pane = wx.Panel(self.sort_splitter, -1)
        ...
        # Tool Bar end
        self.tree = wx.TreeCtrl(self.tree_pane, -1, style=wx.TR_HAS_BUTTONS|wx.TR_LINES_AT_ROOT|wx.TR_MULTIPLE|wx.TR_MULTIPLE|wx.TR_EXTENDED|wx.TR_DEFAULT_STYLE|wx.NO_BORDER)
        self.list = SpykeListCtrl(self.list_pane, -1, style=wx.LC_REPORT|wx.NO_BORDER)
        self.spikesortpanel = SpikeSortPanel(self.plot_pane, -1)
        self.chartsortpanel = ChartSortPanel(self.plot_pane, -1)

        self.__set_properties()
        self.__do_layout()

        self.Bind(wx.EVT_TREE_SEL_CHANGED, self.OnTreeSelectChanged, self.tree)
        self.Bind(wx.EVT_TREE_KEY_DOWN, self.OnTreeKeyDown, self.tree)
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnListDeselect, self.list)
        self.Bind(wx.EVT_LIST_BEGIN_DRAG, self.OnListBeginDrag, self.list)
    ...
    def __set_properties(self):
        ...
        self.SetSize((460, 730))
        self.toolbar.Realize()
        self.spikesortpanel.SetMinSize((160, 670))
        self.chartsortpanel.Enable(False)
        self.chartsortpanel.Hide()
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        self.tree_pane.SetSizer(sizer_2)
        sizer_9.Add(self.list, 1, wx.EXPAND, 0)
        self.list_pane.SetSizer(sizer_9)
        self.sort_splitter.SplitVertically(self.tree_pane, self.list_pane, 117)
        plot_sizer.Add(self.spikesortpanel, 1, wx.EXPAND, 0)
        plot_sizer.Add(self.chartsortpanel, 1, wx.EXPAND, 0)
    ...
    def OnTreeSelectChanged(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnTreeSelectChanged' not implemented!"
        event.Skip()

    def OnTreeKeyDown(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnTreeKeyDown' not implemented!"
        event.Skip()
    ...
    def OnListBeginDrag(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnListBeginDrag' not implemented!"
        event.Skip()

    def OnListKeyDown(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnListKeyDown' not implemented!"
        event.Skip()
