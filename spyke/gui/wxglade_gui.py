#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri May 30 17:45:33 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.fixed_radio_btn = wx.RadioButton(self.detect_pane, -1, "Fixed: ")
        self.fixed_thresh_spin_ctrl = wx.SpinCtrl(self.detect_pane, -1, "50", min=0, max=100)
        self.label_1 = wx.StaticText(self.detect_pane, -1, "uV")
        self.dynamic_radio_btn = wx.RadioButton(self.detect_pane, -1, "Dynamic:")
        self.noise_mult_spin_ctrl = wx.SpinCtrl(self.detect_pane, -1, "", min=0, max=100)
        self.label_2 = wx.StaticText(self.detect_pane, -1, "*")
        self.noise_method_choice = wx.Choice(self.detect_pane, -1, choices=["median", "stdev"])
        self.range_start_combo_box = wx.ComboBox(self.detect_pane, -1, choices=["start", "end"], style=wx.CB_DROPDOWN)
        self.label_5 = wx.StaticText(self.detect_pane, -1, "to")
        self.range_end_combo_box = wx.ComboBox(self.detect_pane, -1, choices=["end", "start"], style=wx.CB_DROPDOWN)
        ...
        self.blocksize_combo_box = wx.ComboBox(self.detect_pane, -1, choices=["1000000"], style=wx.CB_DROPDOWN)
        ...
        self.Bind(wx.EVT_RADIOBUTTON, self.OnFixed, self.fixed_radio_btn)
        self.Bind(wx.EVT_RADIOBUTTON, self.OnDynamic, self.dynamic_radio_btn)
    ...
    def __set_properties(self):
        ...
        self.fixed_radio_btn.SetValue(1)
        self.fixed_thresh_spin_ctrl.SetMinSize((55, -1))
        self.noise_mult_spin_ctrl.SetMinSize((45, -1))
        ...
        self.blocksize_combo_box.SetSelection(0)
    ...
    def __do_layout(self):
        ...
        sizer_3.Add(self.fixed_radio_btn, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_4.Add(self.fixed_thresh_spin_ctrl, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_5.Add(self.dynamic_radio_btn, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_6_copy.Add(self.noise_mult_spin_ctrl, 0, wx.ALIGN_CENTER_VERTICAL, 0)
