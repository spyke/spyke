#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri May 30 16:59:42 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.combo_box_1 = wx.ComboBox(self.detect_pane, -1, choices=["start", "end"], style=wx.CB_DROPDOWN)
        self.label_5 = wx.StaticText(self.detect_pane, -1, "to")
        self.combo_box_2 = wx.ComboBox(self.detect_pane, -1, choices=["end", "start"], style=wx.CB_DROPDOWN)
        self.label_6 = wx.StaticText(self.detect_pane, -1, "us")
        self.label_7 = wx.StaticText(self.detect_pane, -1, "nspikes:")
        self.spin_ctrl_2 = wx.SpinCtrl(self.detect_pane, -1, "", min=0, max=100)
        self.label_8 = wx.StaticText(self.detect_pane, -1, "blocksize:")
        self.combo_box_3 = wx.ComboBox(self.detect_pane, -1, choices=["1000000"], style=wx.CB_DROPDOWN)
        self.label_8_copy = wx.StaticText(self.detect_pane, -1, "us")
        self.button_1 = wx.Button(self.detect_pane, -1, "Search")
        self.button_2 = wx.Button(self.detect_pane, -1, "Clear")
        self.checkbox_1 = wx.CheckBox(self.detect_pane, -1, "random sample")
        self.label_3 = wx.StaticText(self.detect_pane, -1, "total nspikes:")
        self.label_4 = wx.StaticText(self.detect_pane, -1, "0")
        self.text_ctrl_1 = wx.TextCtrl(self.detect_pane, -1, "", style=wx.TE_MULTILINE|wx.TE_READONLY)
        ...
        self.Bind(wx.EVT_RADIOBOX, self.OnMethod, self.method_radio_box)
        self.Bind(wx.EVT_RADIOBUTTON, self.OnFixed, self.radio_btn_1)
        self.Bind(wx.EVT_RADIOBUTTON, self.OnDynamic, self.radio_btn_2)
        self.Bind(wx.EVT_BUTTON, self.OnSearch, self.button_1)
        self.Bind(wx.EVT_BUTTON, self.OnClear, self.button_2)
        # end wxGlade

    def __set_properties(self):
        # begin wxGlade: SpykeFrame.__set_properties
        self.SetTitle("spyke")
        self.SetSize((590, 320))
        ...
        self.combo_box_1.SetMinSize((100, -1))
        self.combo_box_1.SetSelection(0)
        self.label_5.SetMinSize((15, -1))
        self.combo_box_2.SetMinSize((100, -1))
        self.combo_box_2.SetSelection(0)
        self.spin_ctrl_2.SetMinSize((100, -1))
    ...
    def __do_layout(self):
        ...
        file_spin_ctrl_and_label_sizer.Add(self.file_spin_ctrl_units, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 7)
        ...
        sizer_6_copy.Add(self.spin_ctrl_1_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_6_copy.Add(self.label_2, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_6_copy.Add(self.choice_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_5.Add(sizer_6_copy, 1, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_1.Add(sizer_5, 0, 0, 0)
        detect_sizer.Add(sizer_1, 0, wx.EXPAND, 0)
        sizer_14.Add(self.combo_box_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_14.Add(self.label_5, 1, wx.LEFT|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_14.Add(self.combo_box_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_14.Add(self.label_6, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 7)
        sizer_2.Add(sizer_14, 0, 0, 0)
        sizer_15.Add(self.label_7, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_12.Add(sizer_15, 1, 0, 0)
        sizer_17.Add(self.spin_ctrl_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_12.Add(sizer_17, 1, 0, 0)
        sizer_11.Add(sizer_12, 1, 0, 0)
        sizer_16.Add(self.label_8, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_13.Add(sizer_16, 1, 0, 0)
        sizer_16_copy.Add(self.combo_box_3, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_16_copy.Add(self.label_8_copy, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 7)
        sizer_13.Add(sizer_16_copy, 1, 0, 0)
        sizer_11.Add(sizer_13, 1, 0, 0)
        sizer_10.Add(sizer_11, 1, 0, 0)
        sizer_2.Add(sizer_10, 0, 0, 0)
        detect_sizer.Add(sizer_2, 0, wx.EXPAND, 0)
        sizer_6.Add(detect_sizer, 0, wx.EXPAND, 0)
        sizer_7_copy.Add(self.button_1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_7_copy.Add(self.button_2, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_7_copy.Add(self.checkbox_1, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 4)
        sizer_8.Add(sizer_7_copy, 0, 0, 0)
        sizer_9.Add(self.label_3, 0, wx.ALL, 4)
        sizer_9.Add(self.label_4, 0, wx.ALL, 4)
    ...
    def OnMethod(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnMethod' not implemented!"
        event.Skip()
