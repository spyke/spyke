#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Sun Jun 29 21:26:39 2008
...
class SortFrame(wx.MiniFrame):
    def __init__(self, *args, **kwds):
        ...
        self.list = wx.ListCtrl(self.list_pane, -1, style=wx.LC_REPORT|wx.NO_BORDER)
    ...
    def OnTreeSelect(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnTreeSelect' not implemented!"
        event.Skip()
