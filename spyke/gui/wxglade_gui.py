#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Sun May 25 12:03:51 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.detect_sizer_staticbox = wx.StaticBox(self.detect_pane, -1, "stuff")
        self.sort_sizer_staticbox = wx.StaticBox(self.sort_pane, -1, "stuff")
        ...
        self.radio_box_1 = wx.RadioBox(self.detect_pane, -1, "radio_box_1", choices=["choice 1", "choice 2", "choice 3"], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        self.choice_1 = wx.Choice(self.detect_pane, -1, choices=[])
        self.spin_button_2 = wx.SpinButton(self.detect_pane, -1 )
        self.radio_box_1_copy = wx.RadioBox(self.sort_pane, -1, "radio_box_1", choices=["choice 1", "choice 2", "choice 3"], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        self.choice_1_copy = wx.Choice(self.sort_pane, -1, choices=[])
        self.spin_button_2_copy = wx.SpinButton(self.sort_pane, -1 )
    ...
    def __do_layout(self):
        ...
        sort_sizer = wx.StaticBoxSizer(self.sort_sizer_staticbox, wx.HORIZONTAL)
        detect_sizer = wx.StaticBoxSizer(self.detect_sizer_staticbox, wx.HORIZONTAL)
        ...
        detect_sizer.Add(self.radio_box_1, 0, 0, 0)
        detect_sizer.Add(self.choice_1, 0, 0, 0)
        detect_sizer.Add(self.spin_button_2, 0, 0, 0)
        self.detect_pane.SetSizer(detect_sizer)
        sort_sizer.Add(self.radio_box_1_copy, 0, 0, 0)
        sort_sizer.Add(self.choice_1_copy, 0, 0, 0)
        sort_sizer.Add(self.spin_button_2_copy, 0, 0, 0)
