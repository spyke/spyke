#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Tue Jun 17 20:16:59 2008
...
class SortFrame(wx.MiniFrame):
    ...
    def OnDeselect(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnDeselect' not implemented!"
        event.Skip()

    def OnSelect(self, event): # wxGlade: SortFrame.<event_handler>
