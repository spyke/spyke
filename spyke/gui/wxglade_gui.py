#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri Jun 06 15:54:23 2008
...
class SortFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.tree_pane = wx.Panel(self.splitter, -1, style=wx.TAB_TRAVERSAL|wx.CLIP_CHILDREN)
    ...
    def __do_layout(self):
        ...
        self.splitter.SplitVertically(self.tree_pane, self.plot_pane)
        sortframe_sizer.Add(self.splitter, 1, wx.EXPAND, 0)
