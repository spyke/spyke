#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Mon Jun 16 01:12:14 2008
...
class SortFrame(wx.MiniFrame):
    def __init__(self, *args, **kwds):
        ...
        self.spikepanel = SpikeSortPanel(self.plot_pane, -1)
        self.chartpanel = ChartSortPanel(self.plot_pane, -1)
    ...
    def __do_layout(self):
        ...
        self.sort_pane.SetSizer(sort_sizer)
        plot_sizer.Add(self.spikepanel, 1, wx.EXPAND, 0)
        plot_sizer.Add(self.chartpanel, 1, wx.EXPAND, 0)
