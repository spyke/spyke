#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Fri Jun 06 20:33:39 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.toolbar.AddSeparator()
        self.toolbar.AddLabelTool(wx.ID_SORTWIN, "Sort", wx.Bitmap("res/blank.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, "Toggle sort window", "Toggle sort window")
        self.toolbar.AddSeparator()
...
class SortFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.plot_splitter = wx.SplitterWindow(self.plot_pane, -1, style=wx.SP_3DSASH)
        self.chart_pane = wx.Panel(self.plot_splitter, -1)
        self.spike_pane = wx.Panel(self.plot_splitter, -1)
        self.sort_pane = wx.Panel(self.splitter, -1, style=wx.TAB_TRAVERSAL|wx.CLIP_CHILDREN)
        self.sort_splitter = wx.SplitterWindow(self.sort_pane, -1, style=wx.SP_3DSASH)
        self.sort_list_pane = wx.Panel(self.sort_splitter, -1)
        self.sort_tree_pane = wx.Panel(self.sort_splitter, -1)
        ...
        # Tool Bar end
        self.sort_tree_ctrl = wx.TreeCtrl(self.sort_tree_pane, -1, style=wx.TR_HAS_BUTTONS|wx.TR_LINES_AT_ROOT|wx.TR_DEFAULT_STYLE|wx.NO_BORDER)
        self.sort_list_ctrl = wx.ListCtrl(self.sort_list_pane, -1, style=wx.LC_REPORT|wx.NO_BORDER)
        self.panel_1 = wx.Panel(self.spike_pane, -1)
        self.panel_2 = wx.Panel(self.chart_pane, -1)
    ...
    def __do_layout(self):
        ...
        chart_pane_sizer = wx.BoxSizer(wx.HORIZONTAL)
        spike_pane_sizer = wx.BoxSizer(wx.HORIZONTAL)
        sort_sizer = wx.BoxSizer(wx.HORIZONTAL)
        sort_list_sizer = wx.BoxSizer(wx.HORIZONTAL)
        sort_tree_sizer = wx.BoxSizer(wx.HORIZONTAL)
        sort_tree_sizer.Add(self.sort_tree_ctrl, 1, wx.EXPAND, 0)
        self.sort_tree_pane.SetSizer(sort_tree_sizer)
        sort_list_sizer.Add(self.sort_list_ctrl, 1, wx.EXPAND, 0)
        self.sort_list_pane.SetSizer(sort_list_sizer)
        self.sort_splitter.SplitVertically(self.sort_tree_pane, self.sort_list_pane)
        sort_sizer.Add(self.sort_splitter, 1, wx.EXPAND, 0)
        self.sort_pane.SetSizer(sort_sizer)
        spike_pane_sizer.Add(self.panel_1, 1, wx.EXPAND, 0)
        self.spike_pane.SetSizer(spike_pane_sizer)
        chart_pane_sizer.Add(self.panel_2, 1, wx.EXPAND, 0)
        self.chart_pane.SetSizer(chart_pane_sizer)
        self.plot_splitter.SplitVertically(self.spike_pane, self.chart_pane)
        plot_sizer.Add(self.plot_splitter, 2, wx.EXPAND, 0)
