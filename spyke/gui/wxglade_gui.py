#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade 0.6.3 on Mon Apr 28 19:07:53 2008
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(12, "LFP window", "Toggle LFP window", wx.ITEM_CHECK)
        ...
        self.toolbar.AddLabelTool(12, "LFP", wx.Bitmap("res/blank.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, "Toggle LFP window", "")
        # Tool Bar end
        ...
        self.button_1 = wx.Button(self.templates_pane, -1, "button_1")
        self.text_ctrl_1 = wx.TextCtrl(self.templates_pane, -1, "")
        self.spin_button_1 = wx.SpinButton(self.templates_pane, -1 )
        ...
        self.Bind(wx.EVT_MENU, self.OnLFP, id=12)
        ...
        self.Bind(wx.EVT_TOOL, self.OnLFP, id=12)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        templates_sizer = wx.BoxSizer(wx.HORIZONTAL)
        ...
        sizer.Add(self.file_control_panel, 0, wx.EXPAND, 1)
        ...
        templates_sizer.Add(self.button_1, 0, 0, 0)
        templates_sizer.Add(self.text_ctrl_1, 0, 0, 0)
        templates_sizer.Add(self.spin_button_1, 0, 0, 0)
        self.templates_pane.SetSizer(templates_sizer)
