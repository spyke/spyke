...
% The following options can improve/deteriorate results. When multiple values are provided for
...
ops.ForceMaxRAMforDat = 24e9; % maximum RAM the algorithm will try to use; on Windows it will autodetect.
