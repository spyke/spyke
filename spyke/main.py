...
class SpykeFrame(SpykeUi, SpykeUiBase):
    """spyke's main frame, uses gui layout generated by QtDesigner"""
    '''
    ...
    '''
    def __init__(self):
        SpykeUiBase.__init__(self)
        self.setupUi(self) # lay it out
