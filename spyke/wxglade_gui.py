#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Wed Dec 16 14:08:31 2009
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "V1", "V2", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "V1", "V2", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "V1", "V2", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
