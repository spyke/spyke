#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Fri Aug 21 00:47:07 2009
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.xpos = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.xori = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.xscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.label_8 = wx.StaticText(self.cluster_params_pane, -1, "y:")
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.ypos = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.yori = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.yscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.label_9 = wx.StaticText(self.cluster_params_pane, -1, "z:")
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.zpos = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.zori = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.zscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=0, max=100)
        self.plot_button = wx.Button(self.cluster_params_pane, -1, "Plot", style=wx.BU_EXACTFIT)
        self.cluster_button = wx.Button(self.cluster_params_pane, -1, "Cluster", style=wx.BU_EXACTFIT)
