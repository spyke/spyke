#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Thu Aug 20 19:04:34 2009
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.sizer_14_staticbox = wx.StaticBox(self.cluster_pane, -1, "Dimensions")
        self.sizer_15_staticbox = wx.StaticBox(self.cluster_pane, -1, "Ellipsoid parameters")
        ...
        self.toolbar.AddLabelTool(wx.ID_CLUSTERWIN, "Cluster", wx.Bitmap("res/blank.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_CHECK, "Toggle cluster window", "Toggle cluster window")
        self.toolbar.AddSeparator()
        ...
        self.cluster_list_box = wx.ListBox(self.cluster_pane, -1, choices=[])
        self.label_1 = wx.StaticText(self.cluster_pane, -1, "x:")
        self.x_combo_box = wx.ComboBox(self.cluster_pane, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.label_4 = wx.StaticText(self.cluster_pane, -1, "y:")
        self.y_combo_box = wx.ComboBox(self.cluster_pane, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.label_6 = wx.StaticText(self.cluster_pane, -1, "z:")
        self.z_combo_box = wx.ComboBox(self.cluster_pane, -1, choices=[], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.plot_button = wx.Button(self.cluster_pane, -1, "Plot")
        self.label_10 = wx.StaticText(self.cluster_pane, -1, "pos")
        self.label_11 = wx.StaticText(self.cluster_pane, -1, "ori")
        self.label_12 = wx.StaticText(self.cluster_pane, -1, "scale")
        self.label_7 = wx.StaticText(self.cluster_pane, -1, "x:")
        self.spin_ctrl_1 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.spin_ctrl_2 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.spin_ctrl_3 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.label_8 = wx.StaticText(self.cluster_pane, -1, "y:")
        self.spin_ctrl_4 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.spin_ctrl_5 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.spin_ctrl_6 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.label_9 = wx.StaticText(self.cluster_pane, -1, "z:")
        self.spin_ctrl_7 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.spin_ctrl_8 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.spin_ctrl_9 = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.button_1 = wx.Button(self.cluster_pane, -1, "Apply ellipsoid")
        ...
        self.Bind(wx.EVT_LISTBOX, self.OnClusterListBox, self.cluster_list_box)
        self.Bind(wx.EVT_COMBOBOX, self.OnXComboBox, self.x_combo_box)
        self.Bind(wx.EVT_COMBOBOX, self.OnYComboBox, self.y_combo_box)
        self.Bind(wx.EVT_COMBOBOX, self.OnZComboBox, self.z_combo_box)
    ...
    def __set_properties(self):
        ...
        self.extract_pane.SetToolTipString("Extract parameters from spikes")
        self.extract_pane.Enable(False)
        self.cluster_list_box.SetMinSize((72, 130))
        self.x_combo_box.SetMinSize((70, -1))
        self.y_combo_box.SetMinSize((70, -1))
        self.z_combo_box.SetMinSize((70, -1))
        self.spin_ctrl_1.SetMinSize((70, -1))
        self.spin_ctrl_2.SetMinSize((70, -1))
        self.spin_ctrl_3.SetMinSize((70, -1))
        self.spin_ctrl_4.SetMinSize((70, -1))
        self.spin_ctrl_5.SetMinSize((70, -1))
        self.spin_ctrl_6.SetMinSize((70, -1))
        self.spin_ctrl_7.SetMinSize((70, -1))
        self.spin_ctrl_8.SetMinSize((70, -1))
        self.spin_ctrl_9.SetMinSize((70, -1))
        self.cluster_pane.SetToolTipString("Cluster spike parameters")
    ...
    def __do_layout(self):
        ...
        grid_sizer_3 = wx.FlexGridSizer(4, 4, 0, 0)
        ...
        sizer_17.Add(self.cluster_list_box, 0, wx.TOP, 3)
        sizer_12.Add(sizer_17, 0, 0, 0)
        sizer_11.Add(sizer_12, 0, 0, 0)
        sizer_14.Add((0, 17), 0, 0, 0)
        grid_sizer_2.Add(self.label_1, 0, wx.ALL, 3)
        grid_sizer_2.Add(self.x_combo_box, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_4, 0, wx.ALL, 3)
        grid_sizer_2.Add(self.y_combo_box, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_6, 0, wx.ALL, 3)
        grid_sizer_2.Add(self.z_combo_box, 0, wx.ALL, 2)
        sizer_14.Add(grid_sizer_2, 0, 0, 0)
        sizer_14.Add(self.plot_button, 0, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL, 2)
        ...
        grid_sizer_3.Add(self.spin_ctrl_1, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_2, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_3, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.label_8, 0, wx.ALL, 4)
        grid_sizer_3.Add(self.spin_ctrl_4, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_5, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_6, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.label_9, 0, wx.ALL, 4)
        grid_sizer_3.Add(self.spin_ctrl_7, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_8, 0, wx.ALL, 2)
        grid_sizer_3.Add(self.spin_ctrl_9, 0, wx.ALL, 2)
        sizer_15.Add(grid_sizer_3, 0, 0, 0)
        sizer_15.Add(self.button_1, 0, wx.ALL|wx.EXPAND, 2)
        sizer_11.Add(sizer_15, 0, 0, 0)
    ...
    def OnClusterListBox(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnClusterListBox' not implemented!"
        event.Skip()

    def OnXComboBox(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnXComboBox' not implemented!"
        event.Skip()

    def OnYComboBox(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnYComboBox' not implemented!"
        event.Skip()

    def OnZComboBox(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnZComboBox' not implemented!"
        event.Skip()
