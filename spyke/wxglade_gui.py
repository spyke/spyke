#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Tue Feb 23 12:21:14 2010 from "C:\bzr\spyke\dev\spyke\wxglade_gui.wxg"
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.extract_radio_box = wx.RadioBox(self.extract_pane, -1, "X-Y localization", choices=["Spatial mean", "Splines 1D fit", "Gaussian fit"], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "IC0", "IC1", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "IC0", "IC1", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "IC0", "IC1", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
    ...
    def __set_properties(self):
        ...
        self.extract_radio_box.SetSelection(2)
    ...
    def __do_layout(self):
        ...
        self.lockout_sizer_staticbox.Lower()
