#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Wed Mar 17 19:23:10 2010 from "C:\bzr\spyke\dev\spyke\wxglade_gui.wxg"
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
