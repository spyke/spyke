#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Wed May 12 13:22:36 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.manual_cluster_pane = wx.Panel(self.notebook, -1)
        self.add_button = wx.Button(self.manual_cluster_pane, -1, "Add", style=wx.BU_EXACTFIT)
        self.del_button = wx.Button(self.manual_cluster_pane, -1, "Del", style=wx.BU_EXACTFIT)
        self.plot_button = wx.Button(self.manual_cluster_pane, -1, "Plot", style=wx.BU_EXACTFIT)
        self.clist = CListCtrl(self.manual_cluster_pane, -1, style=wx.LC_LIST|wx.LC_VIRTUAL|wx.SUNKEN_BORDER)
        self.sizer_12_staticbox = wx.StaticBox(self.manual_cluster_pane, -1, "Clusters")
        self.cluster_params_pane = wx.Panel(self.manual_cluster_pane, -1)
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.auto_cluster_pane = wx.Panel(self.notebook, -1)
        self.dimlist = DimListCtrl(self.auto_cluster_pane, -1, style=wx.LC_LIST|wx.LC_VIRTUAL|wx.LC_NO_HEADER|wx.SUNKEN_BORDER)
        self.sizer_17_copy_copy_staticbox = wx.StaticBox(self.auto_cluster_pane, -1, "Cluster dimensions")
        self.label_1 = wx.StaticText(self.auto_cluster_pane, -1, "sigma:")
        self.sigma_text_ctrl = wx.TextCtrl(self.auto_cluster_pane, -1, "")
        self.label_1_copy = wx.StaticText(self.auto_cluster_pane, -1, "alpha:")
        self.alpha_text_ctrl = wx.TextCtrl(self.auto_cluster_pane, -1, "")
        self.label_1_copy_1 = wx.StaticText(self.auto_cluster_pane, -1, "subsample:")
        self.subsample_spin_ctrl = wx.SpinCtrl(self.auto_cluster_pane, -1, "", min=1, max=1000)
        self.label_1_copy_2 = wx.StaticText(self.auto_cluster_pane, -1, "maxstill:")
        self.maxstill_spin_ctrl = wx.SpinCtrl(self.auto_cluster_pane, -1, "", min=1, max=1000)
        self.climb_button = wx.Button(self.auto_cluster_pane, -1, "Climb", style=wx.BU_EXACTFIT)
        self.sizer_10_staticbox = wx.StaticBox(self.auto_cluster_pane, -1, "Climbing parameters")
        self.merge_button = wx.Button(self.auto_cluster_pane, -1, "Merge", style=wx.BU_EXACTFIT)
        self.del_button_copy = wx.Button(self.auto_cluster_pane, -1, "Del", style=wx.BU_EXACTFIT)
        self.clist_copy = CListCtrl(self.auto_cluster_pane, -1, style=wx.LC_LIST|wx.LC_VIRTUAL|wx.SUNKEN_BORDER)
        self.sizer_12_copy_staticbox = wx.StaticBox(self.auto_cluster_pane, -1, "Clusters")
        self.cluster_params_pane_copy = wx.Panel(self.auto_cluster_pane, -1)
        self.label_13_copy = wx.StaticText(self.cluster_params_pane_copy, -1, "dims")
        self.label_12_copy = wx.StaticText(self.cluster_params_pane_copy, -1, "scale")
        self.label_7_copy = wx.StaticText(self.cluster_params_pane_copy, -1, "x:")
        self.xdim_copy = wx.ComboBox(self.cluster_params_pane_copy, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.xscale_copy = wx.SpinCtrl(self.cluster_params_pane_copy, -1, "", min=0, max=2147483647)
        self.label_8_copy = wx.StaticText(self.cluster_params_pane_copy, -1, "y:")
        self.ydim_copy = wx.ComboBox(self.cluster_params_pane_copy, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.yscale_copy = wx.SpinCtrl(self.cluster_params_pane_copy, -1, "", min=0, max=2147483647)
        self.label_9_copy = wx.StaticText(self.cluster_params_pane_copy, -1, "z:")
        self.zdim_copy = wx.ComboBox(self.cluster_params_pane_copy, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "w0", "w1", "w2", "w3", "w4", "dphase", "t", "s0", "s1", "mVpp", "mV0", "mV1", "mdphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.zscale_copy = wx.SpinCtrl(self.cluster_params_pane_copy, -1, "", min=0, max=2147483647)
        self.plot_button_copy = wx.Button(self.cluster_params_pane_copy, -1, "Plot", style=wx.BU_EXACTFIT)
        self.sizer_15_copy_staticbox = wx.StaticBox(self.cluster_params_pane_copy, -1, "Plot parameters")
        ...
        self.Bind(wx.EVT_BUTTON, self.OnMergeCluster, self.merge_button)
        self.Bind(wx.EVT_BUTTON, self.OnDelCluster, self.del_button_copy)
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnCListSelect, self.clist_copy)
        self.Bind(wx.EVT_LIST_ITEM_SELECTED, self.OnCListSelect, self.clist_copy)
        self.Bind(wx.EVT_LIST_ITEM_FOCUSED, self.OnCListSelect, self.clist_copy)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.xdim_copy)
        self.Bind(wx.EVT_SPINCTRL, self.OnXScale, self.xscale_copy)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.ydim_copy)
        self.Bind(wx.EVT_SPINCTRL, self.OnYScale, self.yscale_copy)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.zdim_copy)
        self.Bind(wx.EVT_SPINCTRL, self.OnZScale, self.zscale_copy)
        self.Bind(wx.EVT_BUTTON, self.OnClusterPlot, self.plot_button_copy)
        # end wxGlade
    ...
    def __set_properties(self):
        ...
        self.manual_cluster_pane.SetToolTipString("Cluster parameters")
        self.dimlist.SetMinSize((100, 140))
        self.sigma_text_ctrl.SetMinSize((38, -1))
        self.alpha_text_ctrl.SetMinSize((38, -1))
        self.subsample_spin_ctrl.SetMinSize((55, -1))
        self.maxstill_spin_ctrl.SetMinSize((55, -1))
        self.clist_copy.SetMinSize((150, 132))
        self.xdim_copy.SetMinSize((70, -1))
        self.xdim_copy.SetSelection(0)
        self.xscale_copy.SetMinSize((70, -1))
        self.ydim_copy.SetMinSize((70, -1))
        self.ydim_copy.SetSelection(1)
        self.yscale_copy.SetMinSize((70, -1))
        self.zdim_copy.SetMinSize((70, -1))
        self.zdim_copy.SetSelection(4)
        self.zscale_copy.SetMinSize((70, -1))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        self.sizer_15_copy_staticbox.Lower()
        sizer_15_copy = wx.StaticBoxSizer(self.sizer_15_copy_staticbox, wx.VERTICAL)
        grid_sizer_3_copy = wx.FlexGridSizer(5, 3, 0, 0)
        ...
        self.manual_cluster_pane.SetSizer(sizer_13)
        sizer_17_copy_copy.Add(self.dimlist, 0, wx.TOP, 3)
        sizer_11_copy.Add(sizer_17_copy_copy, 0, 0, 0)
        ...
        grid_sizer_2.Add(self.subsample_spin_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.maxstill_spin_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.climb_button, 0, 0, 0)
        sizer_10.Add(grid_sizer_2, 0, 0, 0)
        sizer_11_copy.Add(sizer_10, 0, 0, 0)
        sizer_16_copy.Add(self.merge_button, 0, 0, 0)
        sizer_16_copy.Add(self.del_button_copy, 0, 0, 0)
        sizer_16_copy.Add((40, 0), 0, 0, 0)
        sizer_12_copy.Add(sizer_16_copy, 1, 0, 0)
        sizer_17_copy.Add(self.clist_copy, 0, wx.TOP, 3)
        sizer_12_copy.Add(sizer_17_copy, 0, 0, 0)
        sizer_11_copy.Add(sizer_12_copy, 0, 0, 0)
        grid_sizer_3_copy.Add((0, 0), 0, 0, 0)
        grid_sizer_3_copy.Add(self.label_13_copy, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 2)
        grid_sizer_3_copy.Add(self.label_12_copy, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 2)
        grid_sizer_3_copy.Add(self.label_7_copy, 0, wx.ALL, 4)
        grid_sizer_3_copy.Add(self.xdim_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add(self.xscale_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add(self.label_8_copy, 0, wx.ALL, 4)
        grid_sizer_3_copy.Add(self.ydim_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add(self.yscale_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add(self.label_9_copy, 0, wx.ALL, 4)
        grid_sizer_3_copy.Add(self.zdim_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add(self.zscale_copy, 0, wx.ALL, 2)
        grid_sizer_3_copy.Add((0, 0), 0, 0, 0)
        grid_sizer_3_copy.Add(self.plot_button_copy, 0, 0, 0)
        grid_sizer_3_copy.Add((0, 0), 0, 0, 0)
        grid_sizer_3_copy.Add((0, 0), 0, 0, 0)
        sizer_15_copy.Add(grid_sizer_3_copy, 0, 0, 0)
        self.cluster_params_pane_copy.SetSizer(sizer_15_copy)
        sizer_11_copy.Add(self.cluster_params_pane_copy, 1, wx.EXPAND, 0)
        sizer_13_copy.Add(sizer_11_copy, 1, 0, 0)
        self.auto_cluster_pane.SetSizer(sizer_13_copy)
        self.notebook.AddPage(self.detect_pane, "Detect")
        self.notebook.AddPage(self.extract_pane, "Extract")
        self.notebook.AddPage(self.manual_cluster_pane, "Manual Cluster")
        self.notebook.AddPage(self.auto_cluster_pane, "Auto Cluster")
    ...
    def OnMergeCluster(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnMergeCluster' not implemented!"
        event.Skip()
