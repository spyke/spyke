#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Thu Jun 17 19:27:55 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1_copy_1 = wx.StaticText(self.cluster_pane, -1, "subsample:")
        self.subsample_spin_ctrl = wx.SpinCtrl(self.cluster_pane, -1, "", min=1, max=1000)
        self.label_1_copy_2 = wx.StaticText(self.cluster_pane, -1, "maxstill:")
        self.maxstill_spin_ctrl = wx.SpinCtrl(self.cluster_pane, -1, "", min=1, max=1000)
    ...
    def __do_layout(self):
        ...
        grid_sizer_2 = wx.FlexGridSizer(7, 2, 0, 0)
        ...
        sizer_18.Add(sizer_17_copy_copy, 0, 0, 0)
