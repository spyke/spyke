#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Tue Oct 27 17:17:36 2009
...
class SortFrame(wx.MiniFrame):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnNListDeselect, self.nslist)
        self.Bind(wx.EVT_LIST_ITEM_SELECTED, self.OnNListSelect, self.nslist)
    ...
    def __do_layout(self):
        ...
        self.ns_splitter.SplitVertically(self.nlist, self.nslist, 30)
        self.sort_splitter.SplitVertically(self.ns_splitter, self.list, 117)
