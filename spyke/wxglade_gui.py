#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Mon Aug 24 21:46:11 2009
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=1, max=2147483647)
        ...
        self.yscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=1, max=2147483647)
        ...
        self.zscale = wx.SpinCtrl(self.cluster_params_pane, -1, "", min=1, max=2147483647)
        self.plot_button = wx.Button(self.cluster_params_pane, -1, "Plot", style=wx.BU_EXACTFIT)
        self.focus_button = wx.Button(self.cluster_params_pane, -1, "Focus", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_BUTTON, self.OnFocus, self.focus_button)
        self.Bind(wx.EVT_BUTTON, self.OnApplyCluster, self.cluster_button)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        grid_sizer_3 = wx.FlexGridSizer(6, 5, 0, 0)
        ...
        grid_sizer_3.Add(self.focus_button, 0, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL, 2)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
        grid_sizer_3.Add(self.cluster_button, 0, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL, 2)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
    ...
    def OnFocus(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnFocus' not implemented!"
        event.Skip()
