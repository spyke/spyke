#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Fri Aug 21 00:09:02 2009
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xdim = wx.ComboBox(self.cluster_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.xpos = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.xori = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.xscale = wx.SpinCtrl(self.cluster_pane, -1, "20", min=0, max=100)
        self.label_8 = wx.StaticText(self.cluster_pane, -1, "y:")
        self.ydim = wx.ComboBox(self.cluster_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.ypos = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=100)
        self.yori = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.yscale = wx.SpinCtrl(self.cluster_pane, -1, "20", min=0, max=100)
        self.label_9 = wx.StaticText(self.cluster_pane, -1, "z:")
        self.zdim = wx.ComboBox(self.cluster_pane, -1, choices=["x0", "y0", "Vpp"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.zpos = wx.SpinCtrl(self.cluster_pane, -1, "100", min=0, max=100)
        self.zori = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=359, style=wx.SP_WRAP|wx.TE_NOHIDESEL)
        self.zscale = wx.SpinCtrl(self.cluster_pane, -1, "50", min=0, max=100)
        self.plot_button = wx.Button(self.cluster_pane, -1, "Plot", style=wx.BU_EXACTFIT)
        self.cluster_button = wx.Button(self.cluster_pane, -1, "Cluster", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.xpos)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.xori)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.xscale)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.ydim)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.ypos)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.yori)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.yscale)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.zdim)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.zpos)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.zori)
        self.Bind(wx.EVT_SPINCTRL, self.OnClusterParam, self.zscale)
        self.Bind(wx.EVT_BUTTON, self.OnClusterPlot, self.plot_button)
        self.Bind(wx.EVT_BUTTON, self.OnApplyclusters, self.cluster_button)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        grid_sizer_3.Add(self.cluster_button, 0, wx.ALL|wx.EXPAND, 2)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
        grid_sizer_3.Add((0, 0), 0, 0, 0)
    ...
    def OnClusterParam(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnClusterParam' not implemented!"
        event.Skip()
    ...
    def OnApplyclusters(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnApplyclusters' not implemented!"
        event.Skip()
