#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Fri Nov 05 09:19:02 2010

import wx

# begin wxGlade: extracode
from spyke.core import SpykeListCtrl, CListCtrl, DimListCtrl, NListCtrl, NSListCtrl, SListCtrl
...
wx.ID_EXPORTTSCHID = wx.NewId()
wx.ID_EXPORTLFP = wx.NewId()
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu_sub.Append(wx.ID_EXPORTTSCHID, "TsChId", "Export spike to .tschid file", wx.ITEM_NORMAL)
        wxglade_tmp_menu_sub.AppendSeparator()
        wxglade_tmp_menu_sub.Append(wx.ID_EXPORTLFP, "LFP", "Export all LFP data to .lfp file", wx.ITEM_NORMAL)
        ...
        self.fixedthreshuV_spin_ctrl = wx.SpinCtrl(self.detect_pane, -1, "", min=-2147483647, max=2147483647)
        self.fixedthreshuV_units_label = wx.StaticText(self.detect_pane, -1, "uV")
        ...
        self.wavelet_extract_radio_box = wx.RadioBox(self.extract_pane, -1, "Wavelet coefficients", choices=["haar", "db8"], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        self.wavelet_extract_button = wx.Button(self.extract_pane, -1, "Extract")
        self.temporal_extract_radio_box = wx.RadioBox(self.extract_pane, -1, "Temporal coefficients", choices=["2 Gaussians, 6 free params"], majorDimension=0, style=wx.RA_SPECIFY_ROWS)
        self.temporal_extract_button = wx.Button(self.extract_pane, -1, "Extract")
        self.cluster_pane = wx.Panel(self.notebook, -1)
        self.dimlist = DimListCtrl(self.cluster_pane, -1, style=wx.LC_LIST|wx.LC_VIRTUAL|wx.LC_NO_HEADER|wx.SUNKEN_BORDER)
        self.sizer_17_copy_copy_staticbox = wx.StaticBox(self.cluster_pane, -1, "Dims")
        self.climb_button = wx.Button(self.cluster_pane, -1, "Climb", style=wx.BU_EXACTFIT)
        self.label_1 = wx.StaticText(self.cluster_pane, -1, "sigma:")
        self.sigma_text_ctrl = wx.TextCtrl(self.cluster_pane, -1, "")
        self.label_1_copy_3 = wx.StaticText(self.cluster_pane, -1, "rmergex:")
        self.rmergex_text_ctrl = wx.TextCtrl(self.cluster_pane, -1, "")
        self.label_1_copy = wx.StaticText(self.cluster_pane, -1, "alpha:")
        self.alpha_text_ctrl = wx.TextCtrl(self.cluster_pane, -1, "")
        self.label_1_copy_1 = wx.StaticText(self.cluster_pane, -1, "nsamples:")
        self.nsamples_spin_ctrl = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=2147483647)
        self.label_1_copy_2 = wx.StaticText(self.cluster_pane, -1, "maxstill:")
        self.maxstill_spin_ctrl = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=2147483647)
        self.label_1_copy_2_copy_1 = wx.StaticText(self.cluster_pane, -1, "minpoints:")
        self.minpoints_spin_ctrl = wx.SpinCtrl(self.cluster_pane, -1, "", min=0, max=2147483647)
        self.sizer_10_staticbox = wx.StaticBox(self.cluster_pane, -1, "Parameters")
        self.sizer_18_staticbox = wx.StaticBox(self.cluster_pane, -1, "Auto clustering")
        self.add_button = wx.Button(self.cluster_pane, -1, "+", style=wx.BU_EXACTFIT)
        self.del_button = wx.Button(self.cluster_pane, -1, "-", style=wx.BU_EXACTFIT)
        self.merge_button = wx.Button(self.cluster_pane, -1, "^", style=wx.BU_EXACTFIT)
        self.renum_button = wx.Button(self.cluster_pane, -1, "#", style=wx.BU_EXACTFIT)
        self.focus_cluster_button = wx.Button(self.cluster_pane, -1, "O", style=wx.BU_EXACTFIT)
        self.focus_spike_button = wx.Button(self.cluster_pane, -1, ".", style=wx.BU_EXACTFIT)
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "dphase", "t", "s0", "s1"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.xpos = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.xori = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.xscale = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.label_8 = wx.StaticText(self.cluster_params_pane, -1, "y:")
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "dphase", "t", "s0", "s1"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.ypos = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.yori = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.yscale = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.label_9 = wx.StaticText(self.cluster_params_pane, -1, "z:")
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "sx", "sy", "Vpp", "V0", "V1", "dphase", "t", "s0", "s1"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        self.zpos = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.zori = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.zscale = wx.TextCtrl(self.cluster_params_pane, -1, "", style=wx.TE_PROCESS_ENTER)
        self.cut_cluster_button = wx.Button(self.cluster_params_pane, -1, "Cut", style=wx.BU_EXACTFIT)
        self.cut_all_clusters_button = wx.Button(self.cluster_params_pane, -1, "Cut all", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_MENU, self.OnExportTsChId, id=wx.ID_EXPORTTSCHID)
        self.Bind(wx.EVT_MENU, self.OnExportLFP, id=wx.ID_EXPORTLFP)
        ...
        self.Bind(wx.EVT_BUTTON, self.OnTemporalExtract, self.temporal_extract_button)
        self.Bind(wx.EVT_BUTTON, self.OnClimb, self.climb_button)
        self.Bind(wx.EVT_BUTTON, self.OnAddCluster, self.add_button)
        self.Bind(wx.EVT_BUTTON, self.OnDelCluster, self.del_button)
        self.Bind(wx.EVT_BUTTON, self.OnMerge, self.merge_button)
        self.Bind(wx.EVT_BUTTON, self.OnRenumberClusters, self.renum_button)
        self.Bind(wx.EVT_BUTTON, self.OnFocusCurrentCluster, self.focus_cluster_button)
        self.Bind(wx.EVT_BUTTON, self.OnFocusCurrentSpike, self.focus_spike_button)
        ...
        self.Bind(wx.EVT_TEXT_ENTER, self.OnXPos, self.xpos)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnXOri, self.xori)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnXScale, self.xscale)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.ydim)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnYPos, self.ypos)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnYOri, self.yori)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnYScale, self.yscale)
        self.Bind(wx.EVT_COMBOBOX, self.OnDim, self.zdim)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnZPos, self.zpos)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnZOri, self.zori)
        self.Bind(wx.EVT_TEXT_ENTER, self.OnZScale, self.zscale)
        self.Bind(wx.EVT_BUTTON, self.OnCutCluster, self.cut_cluster_button)
        self.Bind(wx.EVT_BUTTON, self.OnCutAllClusters, self.cut_all_clusters_button)
        # end wxGlade

    def __set_properties(self):
        # begin wxGlade: SpykeFrame.__set_properties
        self.SetTitle("spyke")
        self.SetSize((695, 355))
        ...
        self.fixedthreshuV_spin_ctrl.SetMinSize((55, -1))
        ...
        self.detect_button.SetToolTipString("Run spike detection")
        self.detect_pane.SetToolTipString("Detect spikes")
        self.XY_extract_radio_box.SetSelection(0)
        self.wavelet_extract_radio_box.SetSelection(1)
        self.temporal_extract_radio_box.SetSelection(0)
        self.extract_pane.SetToolTipString("Extract spike parameters")
        self.dimlist.SetMinSize((40, 140))
        self.climb_button.SetToolTipString("Run density gradient climbing algorithm")
        self.sigma_text_ctrl.SetMinSize((50, -1))
        self.rmergex_text_ctrl.SetMinSize((50, -1))
        self.alpha_text_ctrl.SetMinSize((50, -1))
        self.nsamples_spin_ctrl.SetMinSize((67, -1))
        self.maxstill_spin_ctrl.SetMinSize((67, -1))
        self.minpoints_spin_ctrl.SetMinSize((67, -1))
        self.add_button.SetToolTipString("Add cluster")
        self.del_button.SetToolTipString("Delete clusters")
        self.merge_button.SetToolTipString("Merge clusters")
        self.renum_button.SetToolTipString("Renumber clusters")
        self.focus_cluster_button.SetToolTipString("Focus current cluster")
        self.focus_spike_button.SetToolTipString("Focus current spike")
        self.plot_button.SetToolTipString("Plot spikes in cluster space")
        self.clist.SetMinSize((206, 162))
        self.xdim.SetMinSize((60, -1))
        self.xdim.SetSelection(0)
        self.xpos.SetMinSize((50, -1))
        self.xori.SetMinSize((50, -1))
        self.xscale.SetMinSize((50, -1))
        self.ydim.SetMinSize((60, -1))
        self.ydim.SetSelection(1)
        self.ypos.SetMinSize((50, -1))
        self.yori.SetMinSize((50, -1))
        self.yscale.SetMinSize((50, -1))
        self.zdim.SetMinSize((60, -1))
        self.zdim.SetSelection(4)
        self.zpos.SetMinSize((50, -1))
        self.zori.SetMinSize((50, -1))
        self.zscale.SetMinSize((50, -1))
        self.cut_cluster_button.SetToolTipString("Assign points within ellipsoid to cluster")
        self.cut_all_clusters_button.SetToolTipString("Assign all points within all ellipsoids to respective clusters")
    ...
    def __do_layout(self):
        ...
        self.sizer_17_copy_copy_staticbox.Lower()
        ...
        sizer_4.Add(self.fixedthreshuV_spin_ctrl, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_4.Add(self.fixedthreshuV_units_label, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        sizer_14_copy_1.Add(self.temporal_extract_radio_box, 0, 0, 0)
        sizer_14_copy_1.Add(self.temporal_extract_button, 0, 0, 0)
        sizer_9.Add(sizer_14_copy_1, 0, 0, 0)
        sizer_2.Add(sizer_9, 1, wx.EXPAND, 0)
        self.extract_pane.SetSizer(sizer_2)
        sizer_17_copy_copy.Add(self.dimlist, 0, wx.TOP, 3)
        sizer_21.Add(sizer_17_copy_copy, 0, 0, 0)
        sizer_21.Add(self.climb_button, 0, 0, 0)
        ...
        grid_sizer_2.Add(self.sigma_text_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy_3, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.rmergex_text_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.alpha_text_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.nsamples_spin_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.maxstill_spin_ctrl, 0, wx.ALL, 2)
        grid_sizer_2.Add(self.label_1_copy_2_copy_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_2.Add(self.minpoints_spin_ctrl, 0, wx.ALL, 2)
        sizer_10.Add(grid_sizer_2, 0, 0, 0)
        sizer_18.Add(sizer_10, 0, 0, 0)
        sizer_11.Add(sizer_18, 0, wx.EXPAND, 0)
        sizer_16.Add(self.add_button, 0, 0, 0)
        sizer_16.Add(self.del_button, 0, 0, 0)
        sizer_16.Add(self.merge_button, 0, 0, 0)
        sizer_16.Add((10, 20), 0, 0, 0)
        sizer_16.Add(self.renum_button, 0, 0, 0)
        sizer_16.Add((10, 20), 0, 0, 0)
        sizer_16.Add(self.focus_cluster_button, 0, 0, 0)
        sizer_16.Add(self.focus_spike_button, 0, 0, 0)
        ...
        sizer_22.Add(self.cut_cluster_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 2)
        sizer_22.Add(self.cut_all_clusters_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 2)
        sizer_15.Add(sizer_22, 1, wx.ALIGN_CENTER_HORIZONTAL, 0)
    ...
    def OnExportTsChId(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnExportTsChId' not implemented!"
        event.Skip()

    def OnExportLFP(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnExportLFP' not implemented!"
        event.Skip()
    ...
    def OnUndo(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnUndo' not implemented!"
        event.Skip()

    def OnRedo(self, event): # wxGlade: SpykeFrame.<event_handler>
    ...
    def OnTemporalExtract(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnTemporalExtract' not implemented!"
        event.Skip()

    def OnClimb(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnClimb' not implemented!"
        event.Skip()
    ...
    def OnMerge(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnMerge' not implemented!"
        event.Skip()

    def OnRenumberClusters(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnRenumberClusters' not implemented!"
        event.Skip()

    def OnFocusCurrentCluster(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnFocusCurrentCluster' not implemented!"
        event.Skip()

    def OnFocusCurrentSpike(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnFocusCurrentSpike' not implemented!"
        event.Skip()
    ...
    def OnCutCluster(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnCutCluster' not implemented!"
        event.Skip()

    def OnCutAllClusters(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnCutAllClusters' not implemented!"
        event.Skip()
