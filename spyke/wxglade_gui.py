#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Tue Jan 19 13:34:52 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V1", "V2", "IC1", "IC2", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V1", "V2", "IC1", "IC2", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "V1", "V2", "IC1", "IC2", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
    ...
    def __set_properties(self):
        ...
        self.extract_radio_box.SetSelection(1)
