#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Tue Oct 27 16:13:52 2009

import wx

# begin wxGlade: extracode
from spyke.core import SpykeListCtrl, SpykeVirtualListCtrl, NListCtrl, NSListCtrl
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.slock_spin_ctrl = wx.SpinCtrl(self.detect_pane, -1, "", min=0, max=2147483647)
        self.spatial_units_label = wx.StaticText(self.detect_pane, -1, "um")
        self.maxnchansperspike_label = wx.StaticText(self.detect_pane, -1, "nchans/\nspike")
        self.maxnchansperspike_spin_ctrl = wx.SpinCtrl(self.detect_pane, -1, "", min=0, max=2147483647)
        self.maxnchansperspike_units_label = wx.StaticText(self.detect_pane, -1, "max")
        ...
        self.xdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.ydim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
        ...
        self.zdim = wx.ComboBox(self.cluster_params_pane, -1, choices=["x0", "y0", "Vpp", "dphase"], style=wx.CB_DROPDOWN|wx.CB_READONLY)
    ...
    def __set_properties(self):
        ...
        self.maxnchansperspike_spin_ctrl.SetMinSize((60, -1))
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.maxnchansperspike_label, 0, 0, 0)
        grid_sizer_1.Add(self.maxnchansperspike_spin_ctrl, 0, 0, 0)
        grid_sizer_1.Add(self.maxnchansperspike_units_label, 0, wx.LEFT|wx.ALIGN_CENTER_VERTICAL, 5)
...
class SortFrame(wx.MiniFrame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_1 = wx.Panel(self.sort_splitter, -1)
        ...
        # Tool Bar end
        self.nlist = NListCtrl(self.panel_1, -1, style=wx.LC_REPORT|wx.LC_VIRTUAL|wx.WANTS_CHARS)
        self.nslist = NSListCtrl(self.panel_1, -1, style=wx.LC_REPORT|wx.LC_VIRTUAL|wx.WANTS_CHARS)
        ...
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnNListDeselect, self.nlist)
        self.Bind(wx.EVT_LIST_ITEM_SELECTED, self.OnNListSelect, self.nlist)
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnNSListDeSelect, self.nslist)
    ...
    def __do_layout(self):
        ...
        sizer_14.Add(self.nlist, 1, wx.EXPAND, 0)
        sizer_14.Add(self.nslist, 1, wx.EXPAND, 0)
        self.panel_1.SetSizer(sizer_14)
        self.sort_splitter.SplitVertically(self.panel_1, self.list, 118)
    ...
    def OnNListDeselect(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnNListDeselect' not implemented!"
        event.Skip()
    ...
    def OnNSListDeSelect(self, event): # wxGlade: SortFrame.<event_handler>
        print "Event handler `OnNSListDeSelect' not implemented!"
        event.Skip()
