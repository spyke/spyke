#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Thu Jun 24 15:51:01 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.reclimb_button = wx.Button(self.cluster_pane, -1, "ReClimb", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_BUTTON, self.OnReClimb, self.reclimb_button)
    ...
    def __set_properties(self):
        ...
        self.reclimb_button.SetToolTipString("ReClimb points")
    ...
    def __do_layout(self):
        ...
        sizer_16.Add(self.reclimb_button, 0, 0, 0)
    ...
    def OnReClimb(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnReClimb' not implemented!"
        event.Skip()
