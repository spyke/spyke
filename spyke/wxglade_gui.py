#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Tue May 11 19:38:10 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.dimlist = CListCtrl(self.auto_cluster_pane, -1, style=wx.LC_LIST|wx.LC_VIRTUAL|wx.SUNKEN_BORDER)
        ...
        self.text_ctrl_1 = wx.TextCtrl(self.auto_cluster_pane, -1, "")
        self.label_1_copy = wx.StaticText(self.auto_cluster_pane, -1, "alpha:")
        self.text_ctrl_1_copy = wx.TextCtrl(self.auto_cluster_pane, -1, "")
        self.label_1_copy_1 = wx.StaticText(self.auto_cluster_pane, -1, "subsample:")
        self.spin_ctrl_1 = wx.SpinCtrl(self.auto_cluster_pane, -1, "", min=1, max=1000)
        self.label_1_copy_2 = wx.StaticText(self.auto_cluster_pane, -1, "maxstill:")
        self.spin_ctrl_2 = wx.SpinCtrl(self.auto_cluster_pane, -1, "", min=1, max=1000)
        self.button_1 = wx.Button(self.auto_cluster_pane, -1, "Climb!", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self.OnDimListSelect, self.dimlist)
        self.Bind(wx.EVT_LIST_ITEM_SELECTED, self.OnDimListSelect, self.dimlist)
        self.Bind(wx.EVT_LIST_ITEM_FOCUSED, self.OnDimListSelect, self.dimlist)
    ...
    def __set_properties(self):
        ...
        self.text_ctrl_1.SetMinSize((38, -1))
        self.text_ctrl_1_copy.SetMinSize((38, -1))
        self.spin_ctrl_1.SetMinSize((55, -1))
        self.spin_ctrl_2.SetMinSize((55, -1))
    ...
    def OnDimListSelect(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnDimListSelect' not implemented!"
        event.Skip()
