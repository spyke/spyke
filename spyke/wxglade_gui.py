#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Sun Sep 12 15:49:17 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_1_copy_2_copy = wx.StaticText(self.cluster_pane, -1, "density thresh:")
        self.density_thresh_text_ctrl = wx.TextCtrl(self.cluster_pane, -1, "")
        self.density_thresh_apply_button = wx.Button(self.cluster_pane, -1, "Apply", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_BUTTON, self.OnApplyDensityThresh, self.density_thresh_apply_button)
    ...
    def __set_properties(self):
        ...
        self.clist.SetMinSize((200, 130))
        self.label_1_copy_2_copy.Enable(False)
        self.density_thresh_text_ctrl.SetMinSize((38, -1))
        self.density_thresh_text_ctrl.Enable(False)
        self.density_thresh_apply_button.SetToolTipString("Apply density threshold to exclude noise points")
        self.density_thresh_apply_button.Enable(False)
    ...
    def __do_layout(self):
        ...
        sizer_19.Add(self.label_1_copy_2_copy, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_19.Add(self.density_thresh_text_ctrl, 0, wx.ALL, 2)
        sizer_19.Add(self.density_thresh_apply_button, 0, 0, 0)
    ...
    def OnApplyDensityThresh(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnApplyDensityThresh' not implemented!"
        event.Skip()
