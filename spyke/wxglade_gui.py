#!/usr/bin/env python
# -*- coding: iso-8859-15 -*-
# generated by wxGlade HG on Fri Jun 18 14:31:11 2010
...
class SpykeFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.split_button = wx.Button(self.cluster_pane, -1, "/", style=wx.BU_EXACTFIT)
        self.renum_button = wx.Button(self.cluster_pane, -1, "#", style=wx.BU_EXACTFIT)
        self.focus_button = wx.Button(self.cluster_pane, -1, ".", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_BUTTON, self.OnMergeClusters, self.merge_button)
        self.Bind(wx.EVT_BUTTON, self.OnSplitCluster, self.split_button)
        self.Bind(wx.EVT_BUTTON, self.OnRenumberClusters, self.renum_button)
        self.Bind(wx.EVT_BUTTON, self.OnFocusCurrentCluster, self.focus_button)
    ...
    def __set_properties(self):
        ...
        self.split_button.SetToolTipString("Split cluster")
        self.renum_button.SetToolTipString("Renumber clusters")
        self.focus_button.SetToolTipString("Focus current cluster")
        ...
        self.xpos.SetMinSize((60, -1))
        self.xori.SetMinSize((60, -1))
        self.xscale.SetMinSize((60, -1))
        self.ydim.SetMinSize((60, -1))
        self.ydim.SetSelection(1)
        self.ypos.SetMinSize((60, -1))
        self.yori.SetMinSize((60, -1))
        self.yscale.SetMinSize((60, -1))
        self.zdim.SetMinSize((60, -1))
        self.zdim.SetSelection(4)
        self.zpos.SetMinSize((60, -1))
        self.zori.SetMinSize((60, -1))
        self.zscale.SetMinSize((60, -1))
        self.apply_cluster_button.SetToolTipString("Assign points within ellipsoid to cluster")
        self.apply_cluster_button_copy.SetToolTipString("Assign all points within all ellipsoids to respective clusters")
    ...
    def __do_layout(self):
        ...
        sizer_16.Add(self.split_button, 0, 0, 0)
        sizer_16.Add(self.renum_button, 0, 0, 0)
        sizer_16.Add((20, 20), 0, 0, 0)
        sizer_16.Add(self.focus_button, 0, 0, 0)
    ...
    def OnMergeClusters(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnMergeClusters' not implemented!"
        event.Skip()

    def OnSplitCluster(self, event): # wxGlade: SpykeFrame.<event_handler>
        print "Event handler `OnSplitCluster' not implemented!"
        event.Skip()
