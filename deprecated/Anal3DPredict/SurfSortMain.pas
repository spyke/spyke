...
uses Windows, Classes, Messages, Dialogs, Menus, Controls, ComCtrls, Forms,
     ...
     Gauges, {WaveFormUnit, }SurfLocateAndSort, Spin, ElectrodeTypes,
     About,SurfAnal,WaveFormPlotUnit;
...
var
  ...
  c,np,p,e,i,nsp,OrigHeight,OrigWidth,tmp,pt : integer;
...
begin
  //For i := 0 to 10 do
    //Showmessage('exp('+inttostr(i*1000)+')='+floattostrf(exp(i*1000),fffixed,8,2));
