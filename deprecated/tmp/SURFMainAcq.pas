...
uses About,Windows, Messages, ShellApi, ExtCtrls, Buttons, StdCtrls, ToolWin, ComCtrls,
  ...
  Forms, Dialogs, Math, Menus, SysUtils,Graphics, Animate, GIFCtrl,
  SurfComm, SurfFile,SurfTypes, SurfPublicTypes, WaveFormUnit, ProbeSet,
  InfoWinUnit, PahUnit, SurfMessage,EnterExtGain, SuperTimer, Surf2SurfBridge;
...
begin
  ...
  begin
    ...
    if Infowin.Update.Checked then
    begin
...
//FileInfoPanel.Panels[1].Text := inttostr(TheTime.Sec);
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              tmpSVal.EventNum := -1;
              tmpSVal.sval := SvRingArray[SvRingWriteIndex].SVal;
...
//FileInfoPanel.Panels[1].Text := inttostr(TheTime.Sec)+','+inttostr(CRPointCount[probeid]);
          ...
          begin
            ...
            begin
              ...
              param := RawRingArray[CheckRawRingArrayIndex+s];
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        drop := diff div 20;//drop 20 percent of the spikes
      ...
      If diff < 0 then {writer ptr has wrapped around}
        ...
        begin
          drop := (SPIKERINGARRAYSIZE + diff) div 20;//drop 20 percent of the spikes
          SpikeRingDisplayReadIndex := (SpikeRingDisplayReadIndex + drop) mod SPIKERINGARRAYSIZE;
          inc(ndroppedspikes,drop);
          exit;
        end;
...
{==============================================================================}
procedure TSurfAcqForm.ZTimerTimer(Sender: TObject);
begin
